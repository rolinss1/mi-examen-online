...
st.set_page_config(page_title="Simulador MINEDU - Ascenso 2024", page_image="🎓", layout="centered")
st.image("mi_foto.jpg", width=150, caption="Profesor(a) Administrador(a)")
